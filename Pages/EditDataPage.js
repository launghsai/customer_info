...
export default EditData = ({ navigation, route: { params: { data } } }) => {
    ...
    return (
        <View style={styles.container}>
            <AppInput notEdit title={'รหัสลูกค้า'} onChange={(text) => { setId(text) }} value={id} type='phone-pad' />
            ...
            <View style={styles.seperator}>
                <AppText>แก้ไขที่อยู่ โดยการลากหมุด</AppText>
            </View>
            ...
            <TouchableOpacity onPress={EditDataPress} style={styles.addButton}>
                <AppText color='white'>แก้ไขข้อมูล</AppText>
            </TouchableOpacity>
        </View>
    )
}
